with Buffers.Bounded, Buffers.Circular;
...
package Audio is private
   ...
   package Cursor_Ring_Stereo_Samples is
     new Buffers.Protected_Cursor_Ring (Gade.Audio_Buffer.Stereo_Sample);
   package Cursor_Ring_Frame_Buffers is new Buffers.Protected_Cursor_Ring (Float_Frame);

   type Source_Ring_Buffer_Access is access all Cursor_Ring_Stereo_Samples.Protected_Circular_Buffer;
